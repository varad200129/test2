...
$rootScope.App.ID = "com.appbuilder.qrcode";
$rootScope.App.Name = "QrCode (Created with an unregistered version of DecSoft's App Builder)";
$rootScope.App.ShortName = "QrCode";
...
$rootScope.QrCodeTarget.ABRole = 6001;
$rootScope.QrCodeTarget.Hidden = "";
$rootScope.QrCodeTarget.Class = "ios-inertial-scroll ";
$rootScope.QrCodeTarget.Title = "";
$rootScope.QrCodeTarget.TooltipText = "";
$rootScope.QrCodeTarget.TooltipPos = "top";
$rootScope.QrCodeTarget.PopoverText = "";
$rootScope.QrCodeTarget.PopoverEvent = "mouseenter";
$rootScope.QrCodeTarget.PopoverTitle = "";
$rootScope.QrCodeTarget.PopoverPos = "top";

$rootScope.QrCodeButton = {};
$rootScope.QrCodeButton.ABRole = 2001;
$rootScope.QrCodeButton.Hidden = "";
$rootScope.QrCodeButton.Title = "";
$rootScope.QrCodeButton.TabIndex = -1;
$rootScope.QrCodeButton.TooltipText = "";
$rootScope.QrCodeButton.TooltipPos = "top";
$rootScope.QrCodeButton.PopoverText = "";
$rootScope.QrCodeButton.PopoverTitle = "";
$rootScope.QrCodeButton.PopoverEvent = "mouseenter";
$rootScope.QrCodeButton.PopoverPos = "top";
$rootScope.QrCodeButton.Badge = "";
$rootScope.QrCodeButton.Icon = "fa fa-qrcode fa-lg";
$rootScope.QrCodeButton.Text = "Generate QR";
$rootScope.QrCodeButton.Class = "btn btn-primary btn-md ";
$rootScope.QrCodeButton.Disabled = "";

$rootScope.QrCodeInput = {};
$rootScope.QrCodeInput.ABRole = 3001;
$rootScope.QrCodeInput.Hidden = "";
$rootScope.QrCodeInput.Value = "Hello world!";
$rootScope.QrCodeInput.Title = "";
$rootScope.QrCodeInput.TabIndex = -1;
$rootScope.QrCodeInput.TooltipText = "";
$rootScope.QrCodeInput.TooltipPos = "top";
$rootScope.QrCodeInput.PopoverText = "";
$rootScope.QrCodeInput.PopoverEvent = "mouseenter";
$rootScope.QrCodeInput.PopoverTitle = "";
$rootScope.QrCodeInput.PopoverPos = "top";
$rootScope.QrCodeInput.PlaceHolder = "";
$rootScope.QrCodeInput.Class = "form-control form-control-md ";
$rootScope.QrCodeInput.Disabled = "";
$rootScope.QrCodeInput.ReadOnly = "";
    };
